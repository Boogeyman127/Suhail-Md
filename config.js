...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "27780478735,923xxxxxxxx";
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "Thando",
  packname: process.env.PACK_NAME || "Thando made it",
  botname : process.env.BOT_NAME  || "TD",
  ownername:process.env.OWNER_NAME|| "Thando",
